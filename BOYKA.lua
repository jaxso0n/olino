...
os.execute('wget https://raw.githubusercontent.com/jaxso0n/olino/master/BOYKA.lua')
...
if text == 'تحديث المتجر ❃' and DevBOYKAW(msg) then 
  ...
  io.popen("cd File_Bot && wget https://raw.githubusercontent.com/jaxso0n/olino/master/File_Bot/ga.lua")  
  io.popen("cd File_Bot && wget https://raw.githubusercontent.com/jaxso0n/olino/master/File_Bot/rd.lua") 
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/J_ax_s_o_N) \n ❃∫ [قناه السورس](t.me/J_ax_s_o_N)')
end
...
Text = [[
  ...
  ↬ .JAXSON 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
  ↬ . [Channel](t.me/J_ax_s_o_N)  
  
  ↬ . [DEVELOPER](t.me/JAXSO0N)       
   
  ↬ . [Information](t.me/J_ax_s_o_N) 
   
  ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉  
  ↬ . [TWS ](t.me/M0o_oO_DY_2bot)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if DevBOYKAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/jaxso0n/olino/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/jaxso0n/olino/master/File_Bot/"..file)
if res == 200 then
...
return false
  ...
  local Text =[[
    ...
    *❃م10 ◂ اوامر الاعضاء*
    ٴ≪━━━━━━𝐽𝑋━━━━━━≫ٴ
    彡 .[𝐽𝐴𝑋𝑆𝑂𝑁 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/J_ax_s_o_N)➢ 
  ]]
  keyboard = {} 
  ...
  {
  {text = '𝐽𝐴𝑋𝑆𝑂𝑁 {𝐑} 𝐓𝐄𝐀𝐌', url="t.me/J_ax_s_o_N"},
  },
  }
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━𝐽𝑋━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[𝐽𝐴𝑋𝑆𝑂𝑁 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/J_ax_s_o_N)➢ ')
end
