...
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑶𝑳𝑰𝑨𝑵𝑶', url = "https://t.me/J_ax_s_o_N"},
},
}
...
usertext = '\n ღ العضو ← ['..result.title_..'](t.me/'..(username or 'J_ax_s_o_N')..')'
status  = '\n ღ تم ترقيته مطور'
...
usertext = '\n ღ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'J_ax_s_o_N')..')'
status  = '\n ღ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ღ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'J_ax_s_o_N')..') \n ღ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ღ العضو : {["..data.first_name_.."](t.me/J_ax_s_o_N)}\n ღ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ღ عذرا ← {["..data.first_name_.."](t.me/J_ax_s_o_N)}\n ღ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
{{text = '❨ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑶𝑳𝑰𝑨𝑵𝑶 ❩ ',url="t.me/J_ax_s_o_N"}}, 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ღ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'J_ax_s_o_N')..') \n ღ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ღ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'J_ax_s_o_N')..') \n ღ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ღ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'J_ax_s_o_N')..')'
status  = '\n ღ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ღ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ღ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'J_ax_s_o_N')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ღ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'J_ax_s_o_N')..')'..'\n ღ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '♬ 𝐒𝐎𝐔𝐑𝐂𝐄 𝑶𝑳𝑰𝑨𝑵𝑶 ♬.',url="t.me/J_ax_s_o_N"}},
}
local msg_id = msg.id_/2097152/0.5
