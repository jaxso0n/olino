...
sudo_users = {SUDO,1741899314,20,1741899314,30,50}   
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'جـاكـسـون'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ♬ 𝐒𝐎𝐔𝐑𝐂𝐄 𝑱𝑨𝑿𝑺𝑶𝑵 ♬")  
...
os.execute('wget https://raw.githubusercontent.com/jaxso0n/olino/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'♔ تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ♔ اصدار سورس جـاكـسـون { s: 6.7}')
end
if text == 'مالك السورس' or text == 'المبرمج جاكسون' or text == 'جاكسون مبرمج السورس' or text =='جاكسون' then
local Text =[[


للتواصل مع جاكسون مبرمج السورس
...
{
{text = 'ＤеＶ ЈᗩＸṢỌＮ', url = "https://t.me/JAXSO0N"},
},
{
...
if text == 'تتنننو' or text == 'ننتااتن' or text == 'متلبلتتتتلهم' or text =='ااااليلتارار' then
local Text =[[


للتواصل مع 𝙷𝙷𝙷𝙷𝙷 مطور السورس
اتبع الازرار الاتيه♦️
...
if text == 'اتتتور' or text == 'تتتااا' or text == 'ررتتتاال مبرمج ووووننت' or text =='التتازدتهقر' then
local Text =[[


للتواصل مع رروورنمتل مبرمج السورس
اتبع الازرار الاتيه♦️
...
{
{text = '❨ 𝐓𝐖𝐀𝐒𝐎𝐋 ♬  ❩' , url = "https://t.me/M0o_oO_DY_2bot"},
},
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑱𝑨𝑿𝑺𝑶𝑵', url = "https://t.me/J_ax_s_o_N"},
},
...
if text == 'جـاكـسـون' or text == 'سورس' or text == 'السورس' or text == 'source' or text == 'يا سورس' or text == 'OLIANO' then 
local msg_id = msg.id_/2097152/0.5  
local Text = [[ 
╭──── ● ☆ ● ────╮
☆
...
if text == 'جاكسون' or text == 'المبرمج جاكسون' or text == 'جاكسون مبرمج السورس' or text == 'جاكسون الهقر' then
local Text =[[
...
{
{text = '𓆩⦅➥⁽✘ ج‘ــآكسون ✘₎⦆𓆪✹⃝⁦꙰🇭🇰𖤐', url = "https://t.me/JAXSO0N"},
},
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑱𝑨𝑿𝑺𝑶𝑵', url = "https://t.me/J_ax_s_o_N"},
},
...
if text == 'اتتتا' or text == 'تننتاال' or text == 'عهتتتت مبرمج تتتتتت' or text اانن' then
local Text =[[


للتواصل مع تتتت مبرمج السورس
اتبع الازرار الاتيه♦️
...
if text == 'اتتتتا' or text == 'اتتتتتا' or text == 'تتننتاال مطور ااااااااامحح' or text == 'تيرارارار' then
local Text =[[


للتواصل مع تتتتال مطور السورس
اتبع الازرار الاتيه♦️
...
if text == 'ننتااا' or text == 'ههههه' then
local Text = [[
   حصلخير بحبك @تتتتالخخخه
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨ هخخخعال  ❩ ',url="تنننتالب"}},
}
local msg_id = msg.id_/2097152/0.5
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس جـاكـسـون ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس جـاكـسـون ؟ ", 
"كم مره حبيت؟ ", 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ ♬ 𝐒𝐎𝐔𝐑𝐂𝐄 ♬  ❩', url="t.me/J_ax_s_o_N"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '♔═───═𝑱𝑨𝑿𝑺𝑶𝑵═───═♔' then
local Text = [[ 
♬من أحسن السورسات على التليجرام سورس جـاكـسـون♬
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ عععالاا  ❩',url="tاااااال"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'العاب جـاكـسـون' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ♬ اهلا في قائمه الالعاب المتطوره سورس جـاكـسـون  ♬ 
...
if Get_info then
local TextS = "\n ♔ اهلا بك في متجر ملفات جـاكـسـون\n ♔ ملفات السورس ↓\n≪◤━───━??𝗼𝗼𝗼𝗻━───━◥≫\n\n"
...
send(msg.chat_id_, msg.id_," ♔ عذرا الملف لايدعم سورس جـاكـسـون \n") 
end
return false
end
...
if text == ("مسح قائمه جـاكـسـون") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ♔ تم مسح قائمه جـاكـسـون')
return false
end

if text == 'قائمه جـاكـسـون' and Sudo(msg) then
...
if #list == 0 then
t = " ♔ لا يوجد احد في قائمه جـاكـسـون"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع جـاكـسـون") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
send(msg.chat_id_, msg.id_,'['..J_ax_s_o_N..']')
...
if text and text:match("^رفع جـاكـسـون @(.*)$") and Sudo(msg) then
local username = text:match("^رفع جـاكـسـون @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
send(msg.chat_id_, msg.id_,'['..J_ax_s_o_N..']')
...
if text and text:match("^رفع جـاكـسـون (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع جـاكـسـون (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
send(msg.chat_id_, msg.id_,'['..J_ax_s_o_N..']')
...
if text == ("تنزيل جـاكـسـون") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
send(msg.chat_id_, msg.id_,'['..J_ax_s_o_N..']')
...
if text and text:match("^تنزيل جـاكـسـون @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل جـاكـسـون @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
send(msg.chat_id_, msg.id_,'['..J_ax_s_o_N..']')
...
if text and text:match("^تنزيل جـاكـسـون (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل جـاكـسـون (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local J_ax_s_o_N = database:get(bot_id..'text:ch:user')
if J_ax_s_o_N then
send(msg.chat_id_, msg.id_,'['..J_ax_s_o_N..']')
...
Reply_Status(msg,result.id_,"reply","♔ تم تنزيله من المطور")  
else
send(msg.chat_id_, msg.id_,"♔ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","♔ تم تنزيله من مطور ثانوي")  
return false 
end
if text == ("الثانويين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '♬ 𝐒𝐎𝐔𝐑𝐂𝐄 𝑱𝑨𝑿𝑺𝑶𝑵 ♬.',url="t.me/J_ax_s_o_N"}},
}
local msg_id = msg.id_/2097152/0.5
...
end --الكود حصري سورس جـاكـسـون يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'جـاكـسـون').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/J_ax_s_o_N)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/J_ax_s_o_N)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[علي فين يوسخ..🙂😹](t.me/J_ax_s_o_N)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[طب انا بحبك يوه..💔🥺](t.me/J_ax_s_o_N)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بحبح اكتر ..🙂❤️](t.me/J_ax_s_o_N)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ونا كان مين قالي ميسد ..🙂💔](t.me/J_ax_s_o_N)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[شخصيه انت يعني ..🙂😹](t.me/J_ax_s_o_N)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ قولي بحب الفضايح ..🙂😹](t.me/J_ax_s_o_N)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ اومرني يقلبي ..❤️](t.me/J_ax_s_o_N)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ كان نفسي ابقا محترم شبهك بس مجموعي مجبش ..😹🙂](t.me/J_ax_s_o_N)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ هو مفكرني بني ادم ..😹🙂](t.me/J_ax_s_o_N)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يلا متجيش هنا تاني..😹🙂](t.me/J_ax_s_o_N)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[انت الخير يعمري..🌚♥️](t.me/J_ax_s_o_N)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عادي يتفلق هنعلمو اي يعني..💔😒](t.me/J_ax_s_o_N)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/J_ax_s_o_N)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/J_ax_s_o_N)')
return false
end
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'جـاكـسـون').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'جـاكـسـون')
local DRAGON_Msg = {
'نعم يروحي😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'جـاكـسـون')
