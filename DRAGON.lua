...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝗧𝘄𝗮𝘀𝗼𝗹', url="t.me/M0o_oO_DY_2bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '༄𝑫𝒆𝒗:- 𝑱𝑨𝑿𝑺𝑶𝑵',url="t.me/JAXSO0N"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐉𝐀𝐗𝐒𝐎𝐍 𖠛', url="t.me/J_ax_s_o_N"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'جاكسون' or text == 'مبرمج السورس' or text == 'jaxson' then
local Text = [[
DEV JAXSON
]]
keyboard = {} 
...
if result.sender_user_id_ == tonumber(1741899314) then
...
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."J_ax_s_o_N_2:insta_bot"..msg.chat_id_) == "open" then
...
{
{text = '𝒔𝒐𝒖𝒓𝒄𝒆 𝒋𝒂𝒙𝒔𝒐𝒏 𖠭', url="t.me/J_ax_s_o_N"},
