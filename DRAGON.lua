...
if res ~= 200 then
print('\27[0;31m❃═───═𝐽𝐴𝑋𝑆𝑂𝑁═───═❃\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na❃═───═𝐽𝐴𝑋𝑆𝑂𝑁═───═❃\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m❃═───═𝐽𝐴𝑋𝑆𝑂𝑁═───═❃\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ♬ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐽𝐴𝑋𝑆𝑂𝑁 ♬")  
...
if text == 'مالك السورس' or text == 'المبرمج جاكسون' or text == 'جاكسون مبرمج السورس' or text =='جاكسون خيري' then
local Text =[[
...
{
{text = '❃ЈᗩΧSON❃⋮🇹🇷𖤐', url = "https://t.me/JAXSO0N"},
},
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝐽𝐴𝑋𝑆𝑂𝑁', url = "https://t.me/J_ax_s_o_N"},
},
}
...
{
{text = '𝐃𝐞𝐯 ᗰoᏂᎯᗰẼᗪ', url = "https://t.me/JA_XS"},
},
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝐽𝐴𝑋𝑆𝑂𝑁', url = "https://t.me/J_ax_s_o_N"},
},
...
if text == 'جاكسون' or text == 'سورس' or text == 'السورس' or text == 'source' or text == 'يا سورس' or text == 'OLIANO' then 
local msg_id = msg.id_/2097152/0.5  
local Text = [[ 
╭──── ● ☆ ● ────╮
☆
...
keyboard = {}  
keyboard.inline_keyboard = {
{{text = '☼︎𝐷𝑒𝑣 𝐽𝑎ẋ𝑠𝑜𝑛☼︎',url="t.me/JAXSO0N"},{text = '☼︎𝐷𝑒𝑣 𝐽𝑎𝑘𝑠𝑜𝑛☼︎',url="t.me/JAXSO0N"}},
{{text = '  ❨ 𝑺𝑶𝑼𝑹𝑪𝑬 𝐽𝐴𝑋𝑆𝑂𝑁 ❩ ',url="https://t.me/J_ax_s_o_N"}}, 
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '♬ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐽𝐴𝑋𝑆𝑂𝑁 ♬.',url="t.me/J_ax_s_o_N"}},
}
local msg_id = msg.id_/2097152/0.5
