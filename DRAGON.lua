...
sudo_users = {SUDO,1295339524,1236115319,859213488,1124610301}   
...
send(msg.chat_id_, msg.id_,' ★ تم تحديث السورس \n ★ لديك اخر اصدار لسورس جاكسون\n ★ الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ★ اصدار سورس جاكسون \n ★ الاصدار »{ v 1.5}')
end
if text == 'جاكسون مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/JAXSO0N25BOT)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝗧𝘄𝗮𝘀𝗼𝗹', url="t.me/JAXSO0N25BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[
★W𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒕𝒉𝒆 𝒋𝒂𝒙𝒔𝒐𝒏★
★مرحب بيك في سورس جاكسون الاعظم★
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❄JAXSON❄',url="t.me/JAXSO0N"}},
{{text = '❄ᗰ๐ᏂᗩᗰＥᗪ ᗩͲᏐᗩ❄',url="t.me/JA_XS"}},
{{text = '❄SOURSCE❄', url="t.me/J_ax_s_o_N"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'محمد' or text == 'محمد عطيه' or text == 'الهقر' then
local Text = [[
[DEV MOHAMED](t.me/JA_XS)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᗰ๐ᏂᗩᗰＥᗪ ᗩͲᏐᗩ',url="t.me/JA_XS"}},
...
if text == 'BNHG GGFFFK' or text == 'تتتالبتن' or text == 'تنننننت وةتت' then
local Text = [[
[DEV ASALIYA](t.me/AsaliyaEgypt)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'جاكسون' or text == 'JAXSON' or text == 'مبرمج السورس' then
local Text = [[
DEV JAXSON
]]
keyboard = {} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝙨𝙤𝙪𝙧𝙘𝙚', url="t.me/J_ax_s_o_N"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if result.sender_user_id_ == tonumber(1124610301) then
send(msg.chat_id_, msg.id_, " ★ لا يمكنك حظر مطور السورس\n")
return false 
end
...
if tonumber(result.id_) == tonumber(1124610301) then  
send(msg.chat_id_, msg.id_, " ★ لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(result.id_) == tonumber(1295339524) then  
send(msg.chat_id_, msg.id_, " ★ لا تسطيع حظر المبرمج جاكسون عام")
return false 
end
...
if result.sender_user_id_ == tonumber(1295339524) then
send(msg.chat_id_, msg.id_, " ★ لا يمكنك كتم المبرمج جاكسون\n")
return false 
end
if result.sender_user_id_ == tonumber(859213488) then
...
if tonumber(result.id_) == tonumber(1295339524) then  
send(msg.chat_id_, msg.id_, " ★ لا تسطيع كتم المبرمج جاكسون عام")
return false 
end
if tonumber(result.id_) == tonumber(859213488) then  
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙹𝙰𝚇𝚂𝙾𝙽', url="t.me/J_ax_s_o_N"},
{text = 'مبرمج السورس', url="t.me/JAXSO0N"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'≪━━━━━━𝑱𝑨𝑿𝑺𝑶𝑵━━━━━━≫ٴ\n★ [ 𝑱𝑨𝑿𝑺𝑶𝑵 ](t.me/J_ax_s_o_N)')
end
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 ??𝙴𝚂𝙰', url="t.me/J_ax_s_o_N"},
{text = 'مبرمج السورس', url="t.me/JAXSO0N"},
},
}
